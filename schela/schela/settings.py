"""
Django settings for schela project.
...
SECRET_KEY = '7&!72!90^$yf#y&h9@0f+)lm&!)#=eu9vgz6!!jfqark6e!u-6'
...
WSGI_APPLICATION = 'schela.wsgi.application'
